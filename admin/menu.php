    ...
    <ul class="sidebar-menu" style="padding-left: 10px; padding-right: 10px;">
      ...
      <li class="treeview">
        ...
        <ul class="treeview-menu" style="padding-left: 15px;">
          <li>
            <a href="datapelanggan.php" style="border-radius: 6px; margin: 3px 0; color: #ccc;">
              <i class="fa fa-circle-o"></i> Data Karyawan
            </a>
          </li>
          <li>
          <a href="datakurir.php" style="border-radius: 6px; margin: 3px 0; color: #ccc;">
            <i class="fa fa-circle-o"></i> Data Mesenger
          </a>
        </li>
        </ul>
      </li>
      ...
      <li class="treeview">
        <a href="#" style="border-radius: 8px; margin: 4px 0; color: #fff;">
          <i class="fa fa-archive"></i> <span>Mesenger</span> <i class="fa fa-angle-left pull-right"></i>
        </a>
        <ul class="treeview-menu" style="padding-left: 15px;">
          <li>
            <a href="datatransaksibelumterkirim.php" style="border-radius: 6px; margin: 3px 0; color: #ccc;">
              <i class="fa fa-circle-o"></i> Lacak
            </a>
          </li>
          <li>
            <a href="datatransaksiterkirim.php" style="border-radius: 6px; margin: 3px 0; color: #ccc;">
              <i class="fa fa-circle-o"></i> Terkirim
            </a>
          </li>
        </ul>
      </li>
