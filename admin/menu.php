          ...
          <ul class="sidebar-menu">
            ...
            <li>
             ...
             <li>
              ...
              <ul class="treeview-menu">
                <li><a href="datatransaksibelumterkirim.php"><i class="fa fa-circle-o"></i>Lacak</a></li>
                <li><a href="datatransaksiterkirim.php"><i class="fa fa-circle-o"></i>Terkirim</a></li>
              </ul>
            </li>
